...
%   Detailed explanation goes here
    ...
    rel_main_dc_sub = rel_main_dc - rel_main_dc(end-1);
    rel_main_sin_sub = rel_main_sin - rel_main_sin(end-1);
    rel_main_cos_sub = rel_main_cos - rel_main_cos(end-1);
    rel_sec_dc_sub = rel_sec_dc - rel_sec_dc(end-1);
    rel_sec_sin_sub = rel_sec_sin - rel_sec_sin(end-1);
    rel_sec_cos_sub = rel_sec_cos - rel_sec_cos(end-1);
