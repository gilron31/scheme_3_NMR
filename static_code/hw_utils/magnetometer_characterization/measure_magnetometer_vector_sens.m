...
%   Detailed explanation goes here
   %% Software stuff
    ...
    [t, v_ref_x] = sc.Read(ch_ref_x);
    [t, v_ref_y] = sc.Read(ch_ref_y);
    ...
    main_res_to_x_raw = get_sine_parameters(t, v_main, F_SIM_X) / ref_x_phase;
    sec_res_to_x_raw = get_sine_parameters(t, v_sec, F_SIM_X) / ref_x_phase;
    ...
    raw_data.v_main = v_main;
    raw_data.v_sec = v_sec;
